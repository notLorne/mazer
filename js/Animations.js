...
playerStillBack[0] = new Image(); playerStillBack[0].src = "";

const playerStillSide = new Array();
playerStillSide[0] = new Image(); playerStillSide[0].src = "";

const playerRunningFront = new Array();
for ( let k = 0; k < 9; ++k ) {
    playerRunningFront[k] = new Image();
    playerRunningFront[k].src = "assets/playerStillFront_" + k + ".png";
}
